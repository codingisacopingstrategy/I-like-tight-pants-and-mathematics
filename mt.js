...
function mtShowCaptcha() {
    ...
    if (div) {
        div.innerHTML = '<div class="label"><label for="captcha_code">Captcha:</label></div><div class="field"><input type="hidden" name="token" value="zpciLuEdYRzvAuY64CbAdFatqSl8FQB3WTNXqs5J" /><img src="http://mt.schr.fr/mt-comments.cgi/captcha/1/zpciLuEdYRzvAuY64CbAdFatqSl8FQB3WTNXqs5J" width="150" height="35" /><br /><input name="captcha_code" id="captcha_code" value="" autocomplete="off" /><p>Type the characters you see in the picture above.</p></div>';
